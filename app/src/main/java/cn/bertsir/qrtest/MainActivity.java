...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void start() {
        ...
        QrConfig qrConfig = new QrConfig.Builder()
                ...
                .setShowTitle(/*cb_show_title.isChecked()*/true)//显示Title
                .setTitleText("请扫描啦啦啦啦")
                .setShowAlbum(cb_show_album.isChecked())//显示从相册选择按钮
                .setCornerColor(Color.parseColor("#45DDDD"))//设置扫描框颜色
                .setCornerWidth(10)
                .setLineColor(Color.parseColor("#45DDDD"))//设置扫描线颜色
...
//        if (qrConfig != null){
//            qrConfig.setCallBack(new QrConfig.LeadTextCallBack() {
//                @Override
//                public void clickOk() {
//                    Toast.makeText(MainActivity.this,"dianjssjfisfksif",Toast.LENGTH_LONG).show();
//                }
//            });
//        }
